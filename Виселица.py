...
def displayBoard(missedLetters, correctLetters, secretWord):
    ...
    for i in range(len(secretWord)):  # заменяет пропуски угаданными буквами
...
def playAgain():
    ...
    print('Хотите сыграть ище? (да или нет)')
...
while True:
    ...
    # Запрашивает, хочет ли игрок сыграть заново (только если игра заваршена).
    if gameIsDone:
        if playAgain():
            missedLetters = ''
            correctLetters = ''
